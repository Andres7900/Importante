...
function showDedicationText() { //seguidores
  ...
  if (!text) {
    text = `Feliz 20 meses mi Reina Hermosa:\n\nMe alegra saber que a pesar de todo aun seguimos juntos, y le pido a Dios que sea asi para siempre, gracias por estar siempre a mi lado hasta en los peores momentos mi bebita hermosa.\n\nTe prometo que siempre hare lo posible para que nuestra relacion nunca se acabe, y esto solo sea el principio de nuestra vida juntos, gracias por todo y recuerda que Siempre seras mi persona favorita.\n\nTe amo más de lo que puedes imaginar mi niña hermosa.`;  } else {
...
function showSignature() {
  ...
  signature.textContent = firma ? decodeURIComponent(firma) : "ATT: Tu novio";
...
function showCountdown() {
  ...
  let startDate = startParam ? new Date(startParam + 'T00:00:00') : new Date('2023-11-18T00:00:00'); 
  let eventDate = eventParam ? new Date(eventParam + 'T00:00:00') : new Date('2025-11-18T00:00:00');
